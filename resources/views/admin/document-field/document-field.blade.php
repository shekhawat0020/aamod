...
@section('title')
<title>Aamod-Document Field</title>
@stop
@section('inlinecss')
            ...
            <div class="row">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Document Field</h3>
                        <div class="ml-auto pageheader-btn">
                        
                            @can('Document Field Create')
								<a href="{{ route('document-field-create') }}" class="btn btn-success btn-icon text-white mr-2">
									<span>
										<i class="fe fe-plus"></i>
									</span> Add Document Field
								</a>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('document-field-list') }}",
                columns: [
