...
@section('title')
<title>Aamod-Document Group</title>
@stop
@section('inlinecss')
            ...
            <div class="row">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Document Group</h3>
                        <div class="ml-auto pageheader-btn">
                        
                            @can('Document Group Create')
								<a href="{{ route('document-group-create') }}" class="btn btn-success btn-icon text-white mr-2">
									<span>
										<i class="fe fe-plus"></i>
									</span> Add Document Group
								</a>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('document-group-list') }}",
                columns: [
