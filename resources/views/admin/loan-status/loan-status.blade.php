                    ...
                    <div class="card-header">
                        ...
                        <div class="ml-auto pageheader-btn">
                            ...
                            @can('Loan Status Create')
								<a href="{{ route('loan-status-create') }}" class="btn btn-success btn-icon text-white mr-2">
									<span>
										<i class="fe fe-plus"></i>
									</span> Add Loan Status
								</a>
