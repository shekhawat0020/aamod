        ...
        <!-- COL END -->
							<div class="col-lg-12">
								<div class="card">
									...
									<div class="card-body">
                                    <form id="submitForm"  method="post" action="{{route('post-store')}}">
                                    {{csrf_field()}}
                                    <div class="row">
										...
										<div class="form-group col-sm-12">
											...
											<input type="date" class="form-control" name="fill_last_date" id="fill_last_date">
                                        </div>
										
										<div class="form-group col-sm-6">
											<label class="form-label">General Fees*</label>
											<input type="text" class="form-control" name="general_fees" id="general_fees">
                                        </div>
										
										<div class="form-group col-sm-6">
											<label class="form-label">OBC Fees*</label>
											<input type="text" class="form-control" name="obc_fees" id="obc_fees">
                                        </div>
										
										<div class="form-group col-sm-6">
											<label class="form-label">SC Fees*</label>
											<input type="text" class="form-control" name="scst_fees" id="scst_fees">
                                        </div>
										
										<div class="form-group col-sm-6">
											<label class="form-label">ST Fees*</label>
											<input type="text" class="form-control" name="st_fees" id="st_fees">
                                        </div>
										
										<div class="form-group col-sm-6">
											<label class="form-label">Job Token Fees*</label>
											<input type="text" class="form-control" name="token_fees" id="token_fees">
                                        </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data.status){
                        ...
                        successMsg('Create Post', data.msg, btn);
                        $('#submitForm')[0].reset();
						...
						errorMsg('Create Post', 'Input Error');
                    }
                    buttonLoading('reset', $this);
                    
                },
                error: function() {
                    errorMsg('Create Post', 'There has been an error, please alert us immediately');
                    buttonLoading('reset', $this);
                }
