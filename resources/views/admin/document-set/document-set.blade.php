...
@section('title')
<title>Aamod-Document Set</title>
@stop
@section('inlinecss')
            ...
            <div class="row">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Document Set</h3>
                        <div class="ml-auto pageheader-btn">
                        
                            @can('Document Set Create')
								<a href="{{ route('document-set-create') }}" class="btn btn-success btn-icon text-white mr-2">
									<span>
										<i class="fe fe-plus"></i>
									</span> Add Document Set
								</a>
